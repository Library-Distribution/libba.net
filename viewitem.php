			...
			<?php
				if (!isset($id))
				{
					...
					foreach ($items as $item)
					{
						...
						echo "<li id='item{$item['id']}'><a class='item' href='?id={$item['id']}'>{$item['name']}</a> (v{$item['version']}) by <a class='userlink' href='users/{$item['user']['name']}/profile'>{$item['user']['name']}</a></li>";
